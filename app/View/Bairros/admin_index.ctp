<div class="bairros index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $bairro['Bairro']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $bairro['Bairro']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $bairro['Bairro']['id']), null, __('Are you sure you want to delete # %s?', $bairro['Bairro']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
