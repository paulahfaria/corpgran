<div class="imagems index">
	<h2><?php echo __('Imagems'); ?></h2>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($imagem['Empreendimento']['id'], array('controller' => 'empreendimentos', 'action' => 'view', $imagem['Empreendimento']['id'])); ?>
		</td>
		<td><?php echo h($imagem['Imagem']['titulo']); ?>&nbsp;</td>
		<td><?php echo h($imagem['Imagem']['arquivo']); ?>&nbsp;</td>
		<td><?php echo h($imagem['Imagem']['destaque']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $imagem['Imagem']['id']), null, __('Are you sure you want to delete # %s?', $imagem['Imagem']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
